...
class WhiteDwarf(PlanetType): __slots__ = ()
class YellowDwarf(PlanetType): __slots__ = ()
class RedGiant(PlanetType): __slots__ = ()
class Pulsar(PlanetType): __slots__ = ()
