...
lst_animals = [instance for instance in lst_objs if isinstance(instance, Animals)]
lst_plants = [instance for instance in lst_objs if isinstance(instance, Plants)]
lst_mammals = [instance for instance in lst_objs if isinstance(instance, Mammals)]
